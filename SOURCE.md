...
For developers wishing to validate mainline changes, you may use this link: [GUI (Graphical Based App)](https://nightly.link/YBronst/OpenCore-Legacy-Patcher/workflows/build-app-wxpython/main/OpenCore-Patcher.pkg.zip)
...
cd ~/Developer
# Clone project
git clone https://github.com/YBronst/OpenCore-Legacy-Patcher
